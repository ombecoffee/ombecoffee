    ...
    <aside class="main-sidebar fixed offcanvas shadow" data-toggle='offcanvas'>
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview"><a href="/company"><i class="icon fas fa-mail-bulk blue-text"></i>
                        <span>Company</span></a>
                </li>
                <li class="treeview"><a href="/ourcoffee"><i class="icon fas fa-mail-bulk blue-text"></i>
                ...
                {{-- <li><a href="/tender"><i class="icon pink-text fas fa-briefcase"></i> Your Tender <span class="badge r-3 badge-primary pull-right">{{$jumlahtender}}</span></a>
                </li> --}}
